                ...
                <form @submit.prevent="submit" class="flex flex-col gap-6">
                    <div class="grid w-full items-center gap-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <Popover id="wedding_date" v-model:open="isPopoverOpen">
                    ...
                    <div class="pb-6">
                        <Button type="submit" class="mt-2 flex w-full items-center justify-center gap-2" :tabindex="3" :disabled="form.processing">
